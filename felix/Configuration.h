...
#define STRING_CONFIG_H_AUTHOR "(jediminer543, felix config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LHS Felix 1.5"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "cb8a46e2-5816-4143-bae9-33a5c6d4bed4"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 76.20, 76.20, 2580.70, 169.00 }
