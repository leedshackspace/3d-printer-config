...
#define STRING_CONFIG_H_AUTHOR "(JMT, E3D, BigBox)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 WEBSITE_URL         // will be shown during bootup in line 2

#define FAN_PIN 11 //Defines fan pin
#define FAN1_PIN 6 //Defines fan pin
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //E3D V6 (P100, 30W); Taken from BigBox conf
  //#define DEFAULT_Kp 6.52
  //#define DEFAULT_Ki 1.19
  //#define DEFAULT_Kd 160.22
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 180, 3200, 304 }
 ...
 * probe points to avoid hittingF the bed and other hardware.
